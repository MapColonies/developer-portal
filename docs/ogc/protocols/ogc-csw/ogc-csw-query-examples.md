...
# Query Examples
The following section will help you understand how to interface with CSW based catalog.
...
:::caution
Authentication might be required in order to communicate with cata server.
...
## DescribeRecord
**DescribeRecord** operation allows a client to discover elements of the information model supported by the target catalog service. The operation allows some or all of the information model to be described.
...
## GetRecords
**GetRecords** request allows to query the catalog metadata records specifying a query in OCG Filter or CQL languages.
