...
The [/reverse](/docs/MapColonies/openstreetmap/nominatim/Osm-Reverse-Search-API), [/search](/docs/MapColonies/openstreetmap/nominatim/Osm-Search-API) and [/lookup](/docs/MapColonies/openstreetmap/nominatim/Osm-AddressLookup-API)
...
```xml title="Reverse GeoCode Response in XML Format"
