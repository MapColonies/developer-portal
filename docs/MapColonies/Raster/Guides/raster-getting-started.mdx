...
2. Query all records via CSW GetRecords operation and search it in the result response - [Query Examples Documentation](/docs/ogc/protocols/ogc-csw/ogc-csw-examples#getrecords)
