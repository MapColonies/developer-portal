...
2. Query all records via CSW GetRecords operation and search it in the result response - [Query Examples Documentation](/docs/ogc/protocols/ogc-wmts)
...
<figure>
    <img src={require("/img/getcapabilities_response.png")} style={{"display":"block","marginLeft":"auto","marginRight":"auto"}}/>
</figure>
