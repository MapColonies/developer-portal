...
```json
{
    ...
    "numberMatched": 7,
    "numberReturned": 2,
    "timeStamp": "2024-11-11T08:23:27.593Z",
    "crs": {
        "type": "name",
        "properties": {
...
```json
{
    ...
    "numberMatched": 7,
    "numberReturned": 1,
    "timeStamp": "2024-11-11T08:25:39.397Z",
    "links": [
        {
            "title": "previous page",
...
```json
{
    ...
    "numberMatched": 7,
    "numberReturned": 7,
    "timeStamp": "2024-11-11T09:09:32.361Z",
    "crs": {
        "type": "name",
        "properties": {
            "name": "urn:ogc:def:crs:EPSG::4326"
...
```json
{
    ...
    "numberMatched": 1,
    "numberReturned": 1,
    "timeStamp": "2024-11-11T09:12:35.198Z",
    "crs": {
        "type": "name",
        "properties": {
            "name": "urn:ogc:def:crs:EPSG::4326"
...
```json title="Reponse in GeoJSON"
{
    ...
    "numberMatched": 2,
    "numberReturned": 2,
    "timeStamp": "2024-11-11T09:15:52.521Z",
    "crs": {
        "type": "name",
        "properties": {
            "name": "urn:ogc:def:crs:EPSG::4326"
