...
| mc:productType | enum  | **Valid Values**: <br/> 3DPhotoRealistic / 3DPhotoRealisticBest / 3DSemantic / 3DSemanticMesh /QuantizedMeshDTMBest / QuantizedMeshDSMBest <br/> default: 3DPhotoRealistic |
...
| mc:updateDateUTC | date | the date when item was updated in catalog <br/>  <br/> AUTO_GENERATED: ***CURRENT_TIME*** in every update |
