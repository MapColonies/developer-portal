...
:::tip
Hardware Acceleration for WebGL / WebGL2 is crucial for 3D tiles rendering performance. for more information click [here](/docs/MapColonies/3D/Guides/HardwareAcceleration).
:::
...
:::info
Pay attention to the authentication you need to provide!
For further information, see: [Authentication](/docs/MapColonies/authentication)
:::
...
This get request is actually the URL from the `mc:links` element from the records showed in catalog service.
