...
Additions:
  * `WMTS_KVP` - was added to links in order to serve kvp capabilities template 
...
refer to [Query Service](/getting-started/vector/services/query_service.md).
...
refer to [OpenStreetMap Carto](/openstreetmap/osm-carto/README.md).
...
refer to [Nominatim](/getting-started/vector/services/nominatim_service.md).

<img src="/assets/images/release-notes/2022-Q4/nominatim_search_he.png" alt="nominatim_search_he">
